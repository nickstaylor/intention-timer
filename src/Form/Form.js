    ...
    <div className="form-timer-container">
      ...
      <section className="form-timer-inner-container">
        ...
        <section className="menu-buttons" >
          ...
          <button className={selected === 'meditate'? "meditate-outline" : "" } id="meditate"
          onClick={(e)=> updateSelected(e.target.id)}>
          <img src={selected === 'meditate' ? meditateActive: meditate} alt="meditate" />
          Meditate</button>

          <button className={selected === 'exercise'? "exercise-outline" : "" } id="exercise"
          onClick={(e)=> updateSelected(e.target.id)}>
          <img src={selected === "exercise" ? exerciseActive : exercise} alt="exercise" />
          Exercise</button>
        </section>

        {/* form section inputs */}
        <section className="activity-description">
          <label htmlFor="description">What would you like to accomplish during this time?</label>
          <input
            type="text"
            name="description"
            maxLength="60"
        ...
        <section className={descError ? "minutes-seconds-error" : "minutes-seconds"}>
          <div className="min-sec-inputs">
            ...
            />
            {minutesError &&
              <p className="min-error"><img src={warning} alt="warning" />Please enter Minutes (0-60)</p>}
          </div>
          <div className="min-sec-inputs">
            ...
            />
            {secondsError &&
              <p className="min-error"><img src={warning} alt="warning" />Please enter Seconds (0-59)</p>}
          </div>
        </section>
        <div className={minutesError ? "start-activity-btn-error" : "start-activity-btn"}>
          <button className="start-activity" onClick={validateForm}>Start Activity</button>
        </div>
